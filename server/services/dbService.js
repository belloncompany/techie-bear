...
const dbService = {
    ...
    async getMenuItems() {
        ...
        for (const item of result.rows) {
            // Check ingredients availability for 1 unit
            ...
            menuItems[category].push({
                ...
                isAvailable: maxPossibleQuantity > 0,
                maxPossibleQuantity: maxPossibleQuantity === Infinity ? null : maxPossibleQuantity,
                unavailableIngredients: unavailableIngredients.length > 0 ? unavailableIngredients : null
            });
        }
        return menuItems;
    },
